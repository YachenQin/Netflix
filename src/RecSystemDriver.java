...
public class RecSystemDriver extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		FileInputFormat.addInputPath(job1, new Path(args[0]));//("file:///home/training/Desktop/netflix_subset/TrainingRatings.txt"));
        FileOutputFormat.setOutputPath(job1, new Path(args[1]));//("file:///home/training/Desktop/temp_full"));
        JobClient.runJob(job1);
		
		FileInputFormat.addInputPath(job2, new Path(args[1]));//("file:///home/training/Desktop/temp_full"));
		FileOutputFormat.setOutputPath(job2, new Path(args[2]));//("file:///home/training/Desktop/finalresult"));
